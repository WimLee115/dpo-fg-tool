...
pub fn geimplementeerd() -> &'static [&'static str] {
    &[
        ...
        "GRO-01", "GRO-02", "GRO-03",
        "BEW-01", "BEW-02",
        "VWO-01",
        "EER-01",
        "DPIA-01",
        "LEK-01", "LEK-03", "LEK-04", "LEK-06", "LEK-07", "LEK-08", "LEK-09", "LEK-12",
    ]
}
...
fn register() -> Vec<Regel> {
    vec![
        ...
        Regel::nieuw("REG-01", "register", "Registerregel onvolledig",
            "een vastgestelde registerregel mist een van de onderdelen van artikel 30",
            Signalerend, Functionaris, "art. 30 AVG", false),
        Regel::nieuw("REG-02", "register", "Register niet herzien",
            "een vastgestelde registerregel is langer dan twaalf maanden niet herzien",
            Signalerend, Functionaris, "art. 5 lid 2 AVG; interne norm", true),
        Regel::nieuw("REG-03", "register", "Geërfd en niet geverifieerd",
            "een overgenomen registerregel is nog niet tegen de bron gecontroleerd",
            Signalerend, Functionaris, "art. 5 lid 2 AVG", true),
        Regel::nieuw("REG-04", "register", "Concept blijft liggen",
            "een registerregel staat langer dan negentig dagen op concept",
            Signalerend, Functionaris, "interne norm", true),
        Regel::nieuw("REG-05", "register", "Registerregel zonder eigenaar",
            "een registerregel heeft geen eigenaar buiten de functionaris",
            Signalerend, Directie, "art. 24 AVG", true),
        Regel::nieuw("REG-06", "register", "Systeem zonder registerregel",
            "een systeem met persoonsgegevens komt in geen enkele registerregel voor",
            Signalerend, Functionaris, "art. 30 AVG", true),
        Regel::nieuw("REG-07", "register", "Doel te ruim omschreven",
            "een doelomschrijving bevat uitsluitend algemene termen",
            Rapporterend, Functionaris, "art. 5 lid 1 onder b AVG", true),
    ]
}

fn grondslag() -> Vec<Regel> {
    vec![
        Regel::nieuw("GRO-01", "grondslag", "Gerechtvaardigd belang zonder afweging",
            "grondslag f zonder vastgelegde belangenafweging",
            Blokkerend, Functionaris, "art. 6 lid 1 onder f AVG", false),
        Regel::nieuw("GRO-02", "grondslag", "Toestemming zonder bewijs",
            "grondslag a zonder vastgelegde bewijsvorm en intrekkingsroute",
            Blokkerend, Functionaris, "art. 7 lid 1 en lid 3 AVG", false),
        Regel::nieuw("GRO-03", "grondslag", "Bijzondere gegevens zonder uitzondering",
            "bijzondere categorieën zonder uitzonderingsgrond",
            Blokkerend, Functionaris, "art. 9 lid 2 AVG", false),
        Regel::nieuw("GRO-04", "grondslag", "Wettelijke grondslag niet aangewezen",
            "grondslag c of e zonder aanwijsbare bepaling",
            Blokkerend, Functionaris, "art. 6 lid 3 AVG", false),
        Regel::nieuw("GRO-05", "grondslag", "Burgerservicenummer zonder grondslag",
            "gebruik van het burgerservicenummer zonder wettelijke bepaling",
            Blokkerend, Functionaris, "art. 87 AVG en art. 46 UAVG", false),
    ]
}

fn bewaartermijn() -> Vec<Regel> {
    vec![
        Regel::nieuw("BEW-01", "bewaartermijn", "Bewaartermijn ontbreekt",
            "een vastgestelde registerregel zonder bewaartermijn",
            Blokkerend, Functionaris, "art. 30 lid 1 onder f AVG", false),
        Regel::nieuw("BEW-02", "bewaartermijn", "Uitstelafspraak verlopen",
            "een uitgestelde bewaartermijn is niet vastgesteld binnen de afgesproken datum",
            Signalerend, Functionaris, "art. 5 lid 1 onder e AVG", true),
        Regel::nieuw("BEW-03", "bewaartermijn", "Schoningsopdracht niet uitgevoerd",
            "een schoningsopdracht is niet uitgevoerd binnen veertien dagen na de uitvoerdatum",
            Signalerend, Systeemeigenaar, "art. 5 lid 1 onder e AVG", true),
        Regel::nieuw("BEW-04", "bewaartermijn", "Bewaartermijn zonder grondslag",
...
fn verwerkers() -> Vec<Regel> {
    vec![
        Regel::nieuw("VWO-01", "verwerkers", "Verwerker zonder overeenkomst",
            "een verwerking met een verwerker zonder actieve verwerkersovereenkomst",
            Blokkerend, Functionaris, "art. 28 lid 3 AVG", false),
        // Signalerend en niet blokkerend: een contract in kaart brengen is werk in uitvoering, geen overtreding.
        Regel::nieuw("VWO-02", "verwerkers", "Contracteisen niet gemapt",
            "een of meer eisen van artikel 28 lid 3 zonder vindplaats in het contract",
            Signalerend, Contracteigenaar, "art. 28 lid 3 AVG", false),
        Regel::nieuw("VWO-04", "verwerkers", "Meldtermijn verwerker te lang",
            "de contractuele meldtermijn van de verwerker is langer dan achtenveertig uur",
            Signalerend, Functionaris, "art. 33 lid 2 AVG", true),
        Regel::nieuw("VWO-09", "verwerkers", "Subverwerkerslijst niet gecontroleerd",
            "de laatste controle van de subverwerkerslijst is ouder dan twaalf maanden",
            Signalerend, Contracteigenaar, "art. 28 lid 2 en lid 4 AVG", true),
        Regel::nieuw("VWO-13", "verwerkers", "Contract getekend na aanvang",
            "de ondertekendatum ligt na de startdatum van de verwerking",
            Rapporterend, Functionaris, "art. 28 lid 3 AVG", false),
    ]
}

fn doorgifte() -> Vec<Regel> {
    vec![
        Regel::nieuw("EER-01", "doorgifte", "Doorgifte zonder waarborg",
            "een ontvanger buiten de EER zonder vastgelegd instrument",
            Blokkerend, Functionaris, "hoofdstuk V AVG", false),
        Regel::nieuw("EER-02", "doorgifte", "Toegangsland onbekend",
            "alleen de opslaglocatie is ingevuld, niet vanwaaruit toegang bestaat",
            Blokkerend, Systeemeigenaar, "hoofdstuk V AVG", false),
        // Signalerend en niet blokkerend: of een beoordeling toereikend is, is een oordeel.
        Regel::nieuw("EER-03", "doorgifte", "Modelbepalingen zonder beoordeling",
            "modelcontractbepalingen zonder afgeronde doorgiftebeoordeling",
            Signalerend, Functionaris, "art. 46 AVG", false),
        Regel::nieuw("EER-06", "doorgifte", "Uitzondering structureel gebruikt",
            "een uitzondering van artikel 49 wordt vaker dan tweemaal per jaar toegepast",
            Signalerend, Functionaris, "art. 49 AVG", true),
        // Signalerend en niet blokkerend: de intrekking van een instrument ligt buiten de macht van de gebruiker.
        Regel::nieuw("EER-07", "doorgifte", "Waarborg vervallen",
            "het instrument waarop deze doorgifte berust is ingetrokken of onder toetsing",
            Signalerend, Functionaris, "hoofdstuk V AVG", false),
    ]
}
...
fn datalekken() -> Vec<Regel> {
    vec![
        Regel::nieuw("LEK-01", "datalekken", "Geen beoordeling binnen twaalf uur",
            "een geregistreerd incident zonder risicobeoordeling na twaalf uur",
            Signalerend, Behandelaar, "art. 33 lid 1 AVG", false),
        Regel::nieuw("LEK-02", "datalekken", "Termijn nadert zonder besluit",
            "minder dan twaalf uur tot de meldtermijn zonder genomen besluit",
            Signalerend, Functionaris, "art. 33 lid 1 AVG", false),
        Regel::nieuw("LEK-03", "datalekken", "Gat tussen kennisname en registratie",
            "meer dan vier uur tussen kennisname en registratie zonder toelichting",
            Blokkerend, Functionaris, "art. 33 lid 1 en lid 5 AVG", true),
        Regel::nieuw("LEK-04", "datalekken", "Niet melden zonder tweede laag",
            "een besluit om niet te melden zonder tweede persoon en zonder afkoelperiode",
            Blokkerend, Functionaris, "art. 33 lid 1 AVG", false),
        Regel::nieuw("LEK-06", "datalekken", "Geen risico bij grote omvang",
            "uitkomst geen risico bij meer dan tweehonderdvijftig betrokkenen",
            Signalerend, Functionaris, "art. 33 lid 1 AVG", true),
        Regel::nieuw("LEK-07", "datalekken", "Geen risico bij gevoelige gegevens",
            "uitkomst geen risico terwijl bijzondere gegevens, een burgerservicenummer of \
             financiële gegevens betrokken zijn",
            Blokkerend, Functionaris, "art. 33 lid 1 jo. art. 9 AVG", false),
        Regel::nieuw("LEK-08", "datalekken", "Besluit spreekt de weging tegen",
            "een risico vastgesteld en toch besloten niet te melden",
            Blokkerend, Functionaris, "art. 33 lid 1 AVG", false),
        Regel::nieuw("LEK-09", "datalekken", "Beschikbaarheid niet beoordeeld",
            "geen van de drie aspecten van de inbreuk is beantwoord",
            Blokkerend, Behandelaar, "art. 4 onder 12 AVG", false),
        Regel::nieuw("LEK-12", "datalekken", "Afgesloten zonder oorzaak of maatregel",
            "een afgesloten incident zonder oorzaakcategorie of zonder maatregel",
            Blokkerend, Functionaris, "art. 33 lid 5 AVG", false),
        Regel::nieuw("LEK-13", "datalekken", "Herhaalde oorzaak",
            "dezelfde oorzaakcategorie meer dan driemaal per kwartaal",
            Rapporterend, Directie, "art. 32 AVG", false),
        Regel::nieuw("LEK-15", "datalekken", "Lek zonder registerkoppeling",
            "een incident dat aan geen enkele verwerking is gekoppeld",
            Signalerend, Functionaris, "art. 30 en art. 33 AVG", true),
        Regel::nieuw("LEK-16", "datalekken", "Verwerker meldde te laat",
            "de verwerker overschreed de contractuele meldtermijn",
            Rapporterend, Contracteigenaar, "art. 33 lid 2 AVG", false),
    ]
}
...
fn organisatie() -> Vec<Regel> {
    vec![
        ...
        Regel::nieuw("ORG-02", "organisatie", "Contactgegevens verouderd",
            "de publicatie van de contactgegevens is ouder dan de rolwisseling",
            Signalerend, Functionaris, "art. 37 lid 7 AVG", true),
        Regel::nieuw("ORG-03", "organisatie", "Geen plaatsvervanger",
            "de rol heeft geen vastgelegde achtervang",
            Signalerend, Directie, "art. 38 lid 2 AVG", true),
        // Signalerend en niet blokkerend: een rolconflict lost de functionaris niet zelf op; dit is een bestuursbesluit.
        Regel::nieuw("ORG-04", "organisatie", "Rolconflict",
            "de functionaris combineert een functie uit de conflictlijst",
            Signalerend, Directie, "art. 38 lid 6 AVG", true),
        Regel::nieuw("ORG-05", "organisatie", "Geen rapportage aan de leiding",
            "geen rapportage aan het hoogste leidinggevende niveau in twaalf maanden",
            Signalerend, Directie, "art. 38 lid 3 AVG", true),
        Regel::nieuw("ORG-07", "organisatie", "Termijn valt in een afwezigheid",
            "een dossier met een termijn in een vastgelegde afwezigheidsperiode zonder overdracht",
            Blokkerend, Functionaris, "art. 12 lid 3 AVG", false),
        Regel::nieuw("ORG-08", "organisatie", "Overdracht zonder terugleeslus",
            "een dossier is overgedragen zonder bevestiging door de ontvanger",
            Blokkerend, Behandelaar, "interne norm", false),
        // Signalerend en niet blokkerend: een toezegging aanvullen is werk, geen overtreding.
        Regel::nieuw("ORG-12", "organisatie", "Toezegging zonder eigenaar",
            "een toezegging aan de toezichthouder zonder eigenaar of einddatum",
            Signalerend, Functionaris, "art. 31 AVG", false),
    ]
}

fn systeem() -> Vec<Regel> {
    vec![
        Regel::nieuw("SYS-04", "toepassing", "Ketenbreuk in het logboek",
            "de integriteitscontrole van het logboek faalt",
            Blokkerend, Beheerder, "art. 5 lid 2 AVG", false),
        Regel::nieuw("SYS-05", "toepassing", "Signaalregel wordt genegeerd",
            "een signalerende regel wordt in een kwartaal meer dan tachtig procent genegeerd",
            Rapporterend, Beheerder, "interne norm", false),
        Regel::nieuw("SYS-06", "toepassing", "Waarschuwingsbudget overschreden",
            "meer dan vijf onderbrekende meldingen per gebruiker per week",
            Rapporterend, Beheerder, "interne norm; behandeld als ontwerpdefect", false),
        Regel::nieuw("SYS-08", "toepassing", "Onafgeronde onomkeerbare handeling",
            "een onomkeerbare handeling is voorbereid maar niet bevestigd of teruggedraaid",
            Blokkerend, Behandelaar, "interne norm", false),
        Regel::nieuw("SYS-09", "toepassing", "Termijnmodule niet geverifieerd",
            "de testgevallen van de termijnmodule zijn na een bijwerking niet groen",
            Blokkerend, Beheerder, "interne norm", false),
        Regel::nieuw("SYS-10", "toepassing", "Klokafwijking",
            "de systeemklok wijkt af van de monotone referentie",
            Signalerend, Beheerder, "art. 5 lid 2 AVG", false),
    ]
}
...
pub fn beoordeel_verwerking(
    ...
    if v.status == Status::Concept && (nu - v.herkomst.aangemaakt_op) > Duration::days(90) {
        voeg(
            "REG-04",
            format!(
                "staat {} dagen op concept",
                (nu - v.herkomst.aangemaakt_op).num_days()
            ),
        );
    }
...
pub fn beoordeel_incident(motor: &Regelmotor, i: &Incident, nu: DateTime<Utc>) -> Vec<Bevinding> {
    ...
    if let Meldbesluit::NietMelden { tweede_persoon, afkoelperiode_tot, .. } = &i.meldbesluit {
        if tweede_persoon.is_none() && afkoelperiode_tot.is_none() {
            voeg("LEK-04", "besloten niet te melden zonder tweede persoon en zonder afkoelperiode".into());
        }
    }
    ...
    if i.risiconiveau == Some(Risiconiveau::GeenRisico) && i.omvang_vereist_tegenspraak() {
        voeg(
            "LEK-06",
            format!(
                "uitkomst geen risico bij {} betrokkenen",
    ...
    if i.risiconiveau == Some(Risiconiveau::GeenRisico) && i.tweede_persoon_verplicht() {
        let tweede_aanwezig = matches!(
            &i.meldbesluit,
            Meldbesluit::NietMelden { tweede_persoon: Some(_), .. }
        );
