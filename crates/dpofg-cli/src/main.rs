...
enum Opdracht {
    ...
    /// Eén lijst met wat er openstaat, over alle regimes heen.
    Werkbak(opdrachten::werkbak::Werkbakargumenten),
...
fn draai() -> Result<()> {
    ...
    match args.opdracht {
        ...
        Opdracht::Werkbak(o) => opdrachten::werkbak::draai(o, args.kluis, nu),
